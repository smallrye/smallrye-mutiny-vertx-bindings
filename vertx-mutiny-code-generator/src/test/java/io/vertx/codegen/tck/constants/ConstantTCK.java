...
public interface ConstantTCK {
    ...
    @Nullable
    RefedInterface1 NULLABLE_NON_NULL = VERTX_GEN;
    @Nullable
    RefedInterface1 NULLABLE_NULL = null;
    ...
    // EXTRA FIELD
    Map<String, RefedInterface1> VERTX_GEN_MAP = Collections.singletonMap("foo", VERTX_GEN);
}
