...
public class DataObjectWithValues {
    ...
    public DataObjectWithValues(JsonObject json) {
        ...
        dataObjectValue = json.getJsonObject("dataObjectValue") != null
                ? new TestDataObject(json.getJsonObject("dataObjectValue"))
                : null;
    ...
    public JsonObject toJson() {
        ...
        return json.put("booleanValue", booleanValue).put("shortValue", (int) shortValue).put("intValue", intValue)
                .put("longValue", longValue).put("floatValue", floatValue).put("doubleValue", doubleValue);
    }
}
