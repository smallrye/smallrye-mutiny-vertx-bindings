...
public interface ConstantTCK {
    ...
    ReferencedVertxGenInterface VERTX_GEN = new ReferencedVertxGenInterfaceImpl().setString("foo");
    TestDataObject DATA_OBJECT = new TestDataObject().setFoo("foo");
    ...
    @Nullable
    ReferencedVertxGenInterface NULLABLE_NON_NULL = VERTX_GEN;
    @Nullable
    ReferencedVertxGenInterface NULLABLE_NULL = null;
    ...
    List<ReferencedVertxGenInterface> VERTX_GEN_LIST = Collections.singletonList(VERTX_GEN);
    ...
    Set<ReferencedVertxGenInterface> VERTX_GEN_SET = Collections.singleton(VERTX_GEN);
