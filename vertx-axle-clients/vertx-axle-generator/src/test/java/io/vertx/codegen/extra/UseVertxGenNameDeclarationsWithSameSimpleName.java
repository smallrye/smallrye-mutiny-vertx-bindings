...
public interface UseVertxGenNameDeclarationsWithSameSimpleName extends
    ...
    @CacheReturn
    io.vertx.codegen.extra.sub.UseVertxGenNameDeclarationsWithSameSimpleName foo(
            io.vertx.codegen.extra.sub.UseVertxGenNameDeclarationsWithSameSimpleName arg);

    void function(
            Function<io.vertx.codegen.extra.sub.UseVertxGenNameDeclarationsWithSameSimpleName, io.vertx.codegen.extra.sub.UseVertxGenNameDeclarationsWithSameSimpleName> function);
