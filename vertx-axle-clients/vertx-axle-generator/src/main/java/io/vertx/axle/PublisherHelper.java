...
public class PublisherHelper {
     ...
     * readstream will be subscribed to the {@link Flowable<T>}.
     * <p>
     *
     ...
     * as they will be used by the flowable adapter.
     * <p>
     *
    ...
    public static <T> Publisher<T> toPublisher(ReadStream<T> stream) {
        return RxJavaPlugins
                .onAssembly(new FlowableReadStream<>(stream, FlowableReadStream.DEFAULT_MAX_BUFFER_SIZE, Function.identity()));
    }
