...
import io.vertx.mutiny.ext.auth.webauthn4j.CredentialStorage;
import io.vertx.mutiny.ext.auth.webauthn4j.WebAuthn4J;

public class WebAuthnTest {

    private Vertx vertx;
    private final DummyStore dummyStore = new DummyStore();
    private final CredentialStorage database = new CredentialStorage(dummyStore);
    ...
    public void testFIDORegister() {
        ...
        JsonObject webauthn = new JsonObject(
    ...
    public void testPAckedFull() {
        WebAuthn4J webAuthN = WebAuthn4J.create(vertx,
                new WebAuthn4JOptions().setRelyingParty(new RelyingParty().setName("FIDO Examples Corporation")))
                .credentialStorage(database);
        final JsonObject webauthn = new JsonObject("{\n" +
    ...
    @Test
    public void testPAckedSurrogate() {
        WebAuthn4J webAuthN = WebAuthn4J.create(
                vertx,
                new WebAuthn4JOptions().setRelyingParty(new RelyingParty().setName("FIDO Examples Corporation"))
    ...
    @Test
    public void testAndroidSafetyNet() {
        WebAuthn4J webAuthN = WebAuthn4J.create(
                vertx,
                new WebAuthn4JOptions().setRelyingParty(new RelyingParty().setName("FIDO Examples Corporation")))
                .credentialStorage(database);
        dummyStore.add(
                new Authenticator()
                        ...
                        .setPublicKey(
                                "pQECAyYgASFYIDhJog_eJsNLAIg5GlgneD3_k4gLFlQIiq369XollUmhIlggdDxLUkXPJoXPkQVDZ81Pr7lITnBZNlEBH8DcznYhxo8")
                        .setCounter(0));
