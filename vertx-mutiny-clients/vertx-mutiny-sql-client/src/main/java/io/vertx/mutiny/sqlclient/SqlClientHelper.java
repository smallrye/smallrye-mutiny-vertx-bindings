...
public class SqlClientHelper {
     ...
     */
    public static <T> Multi<T> inTransactionMulti(Pool pool, Function<Transaction, Multi<T>> sourceSupplier) {
     ...
     */
    public static <T> Uni<T> inTransactionUni(Pool pool, Function<Transaction, Uni<T>> sourceSupplier) {
